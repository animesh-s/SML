...
if __name__ == "__main__":
	...
	for tempC in CArray:
		for tempGamma in GammaArray:
			clf = svm.SVC(C=tempC,gamma=tempGamma)#C=0.01,kernel='rbf',gamma=0.1)
			run_SVM_RBF(clf, tempGamma,tempC, 700)
			run_SVM_RBF(clf, tempGamma,tempC, 2394)  
